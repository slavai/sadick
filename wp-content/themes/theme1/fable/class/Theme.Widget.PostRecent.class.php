...
class ThemeWidgetPostRecent extends ThemeWidget 
{
    ...
    function ThemeWidgetPostRecent() 
	{
		parent::WP_Widget(THEME_CONTEXT.'_widget_post_recent',sprintf(__('(%s theme) Recent posts',THEME_DOMAIN),THEME_NAME),array('description'=>__('Displays latest posts.',THEME_DOMAIN)));
    }
