...
class ThemeWidgetPostMostComment extends ThemeWidget 
{
    ...
    function ThemeWidgetPostMostComment() 
	{
		parent::WP_Widget(THEME_CONTEXT.'_widget_post_most_comment',sprintf(__('(%s theme) Most commented',THEME_DOMAIN),THEME_NAME),array('description'=>__('Displays most commented posts.',THEME_DOMAIN)));
    }
