...
class Theme
{
	...
	function adminCreateMetaBoxHeader()
	{
		...
		ThemeHelper::setDefaultOption($data['option'],'header_enable',-1);
		ThemeHelper::setDefaultOption($data['option'],'header_text_color','');
		ThemeHelper::setDefaultOption($data['option'],'header_background_color','');
		ThemeHelper::setDefaultOption($data['option'],'header_background_image_src','');
		ThemeHelper::setDefaultOption($data['option'],'header_background_image_repeat',-1);
		ThemeHelper::setDefaultOption($data['option'],'header_background_image_position','');
		ThemeHelper::setDefaultOption($data['option'],'header_background_image_size_1',-1);
		ThemeHelper::setDefaultOption($data['option'],'header_background_image_size_2','');
		
		ThemeHelper::setDefaultOption($data['option'],'header_subheader','');
		ThemeHelper::setDefaultOption($data['option'],'header_subheader_text_color','');
	...
	{	
		...
		foreach($query->posts as $value)
		{
			...
			(
				'menu_top'							=>	-1,
				'widget_area_sidebar'				=>	-1,
				'widget_area_sidebar_location'		=>	-1,
				'widget_area_footer'				=>	-1,
				'footer_bottom_enable'				=>	-1,
				'header_enable'						=>	-1,
				'header_background_image_repeat'	=>	-1,
				'header_background_image_size_1'	=>	-1
			);
	...
	function filterExcerptMore()
	{
		...
		if($length>0) return('<span class="excerpt-more"> <a href="'.get_the_permalink().'">[...]</a></span>');
